...
# Die Zitiermakros dieses Projekts: Geschaeftsbericht von AstraZeneca (GB),
# Form 20-F von Dr. Reddy's (ZF), Halbjahresbericht (HJ), Quartalsbericht
# (QB) und Webquelle (Web).
