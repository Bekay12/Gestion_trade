#!/usr/bin/env python3
"""
edgar_seiten.py - zerlegt die EDGAR-Einreichungen von eines Emittenten in gedruckte Seiten.
...
Alamos setzt die Fusszeile je Dokumentart verschieden:
    ...
    Die erkannten Formen stehen in scripts/projekt.py.
...
from projekt import FIRMA, WEITERE_FUSSZEILEN  # noqa: E402
...
_TRENN = r"[|\u2013\u2014-]"
_NAME = "(?:" + "|".join([FIRMA] + list(WEITERE_FUSSZEILEN)) + ")"
# Roemische Seitenzahlen tragen die Vorspanne vieler Einreichungen.
