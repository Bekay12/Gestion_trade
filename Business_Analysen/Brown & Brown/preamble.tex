% ===================================================================
% preamble.tex — Praeambel der finanzwirtschaftlichen Analyse Brown & Brown
% ===================================================================
...
% \quelleGB{2025}{49} belegt den Jahresbericht (Form 10-K) des
% Geschaeftsjahres 2025 auf gedruckter Seite 49. Die Seitenzahl ist die des
% gedruckten Dokuments, nicht die des HTML-Blocks: scripts/edgar_pages.py
% liest sie aus dem Seitenfuss vor jedem Umbruch der EDGAR-Einreichung.
\newcommand{\quelleGB}[2]{\footnote{\quellensprung{quelle:gb#1}{Brown \& Brown,
  Inc., Form 10-K #1}, S.~#2.}}
% \quelleQM traegt den vollen Titel der Einreichung im ersten Argument und
% dient zugleich fuer Proxy Statements (Form DEF 14A).
\newcommand{\quelleQM}[2]{\footnote{\quellensprung{quelle:#1}{Brown \& Brown,
  Inc., #1}, S.~#2.}}
