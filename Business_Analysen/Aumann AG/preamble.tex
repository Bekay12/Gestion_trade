...
% voller Genauigkeit (312.346). Die Formatierung erfolgt ausschliesslich hier.
%   \MioEUR       - Fliesstext, auf eine Nachkommastelle gerundet
%   \MioEURexakt  - Rechenwege, volle im Bericht veroeffentlichte Genauigkeit
% Die Rundung liegt bewusst in der Ausgabe und nicht im gespeicherten Wert,
% damit die Veraenderungsraten aus den exakten Werten hervorgehen.
\newcommand{\MioEUR}[1]{\num[round-mode=places,round-precision=1]{#1}\,Mio.\,\euro}
\newcommand{\MioEURexakt}[1]{\num{#1}\,Mio.\,\euro}
\newcommand{\Pct}[1]{\num{#1}\,\%}
...
\newcommand{\EURje}[1]{\num[round-mode=places,round-precision=2]{#1}\,\euro}
...
% \quelleGB und \quelleQM leiten den Schluessel aus ihrem ersten Argument ab
% (quelle:gb2024 bzw. quelle:<Bezeichnung des Zwischenberichts>). Deshalb
% mussten die Aufrufe im Fliesstext nicht angefasst werden - die Labels im
% Quellenverzeichnis sind passend dazu gesetzt.
\newcommand{\quelleGB}[2]{\footnote{\quellensprung{quelle:gb#1}{Aumann AG,
  Gesch\"aftsbericht #1}, S.~#2.}}
\newcommand{\quelleQM}[2]{\footnote{\quellensprung{quelle:#1}{Aumann AG,
  #1}, S.~#2.}}
% Kurzbeleg wie bei \quelleGB und \quelleQM: Die Fussnote nennt Urheber, Titel
% und Abrufdatum und verweist mit der Nummer auf das Quellenverzeichnis, wo
% die vollstaendige Adresse steht. Zuvor druckte jede Fussnote die volle URL -
% auf belegdichten Seiten fuellte allein der Fussnotenapparat mehrere Zeilen
% mit Adressen, und der Kurzbeleg der Berichte stand unvermittelt neben einem
% Volltextlink.
%
% Das zweite Argument ist der \label-Schluessel des Eintrags im
% Quellenverzeichnis (Konvention "quelle:<kurzname>"), NICHT die Adresse: So
% steht jede URL genau einmal im Dokument - dieselbe Regel, die fuer
% Zahlenwerte gilt. Der Schluessel dient zugleich
% scripts/check_footnote_pages.py dazu, zwei verschiedene Webquellen auf
% derselben Seite auseinanderzuhalten.
